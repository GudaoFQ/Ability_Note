...
#### 基本说明
> 1.7版本
![multithreading-unsafe基本说明](../resource/multithreading/multithreading-unsafe基本说明.jpg)
* 1.8能通过反射使用
* 后期版本好像不能使用了
* 底层使用CPU原语实现
...
![multithreading-unsafe类说明](../resource/multithreading/multithreading-unsafe类说明.jpg)
#### Unsafe类部分方法说明
```java
/*Class类相关*/
