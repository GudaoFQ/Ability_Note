...
### 安装配置
* CentOS：8
* Maven：apache-maven-3.8.2-bin.tar.gz

### 安装
#### maven官网下载对应的版本 (linux)
...
```text
执行 mvn -v 出现下列问题
which: no java in (/usr/local/apache-maven-3.8.2/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/root/bin)
The JAVA_HOME environment variable is not defined correctly,
this environment variable is needed to run this program.

解决：
安装java环境（看【YC】java环境配置.md）
```
